(function (global, factory) {
	...
	function __element79(values, components, key) {
		var props = {
		};
		props["key"] = key;
		var children = [
	...
	function __element80(values, components, key) {
		var children = [
			"3",
			"4",
			"5"
	...
	function __element81(values, components, key) {
		var props = {
			"background": "#aaa",
			"color": "white"
		};
	...
	function __element82(values, components, key) {
		var props = {
			"arr": __element80(values, components, "arr"),
			"foo": "bar",
			"styles": __element81(values, components, "styles"),
			"val": "foo"
		};
		props["key"] = key;
		var children = [
	...
	function __element83(values, components, key) {
		var props = {
		};
		props["key"] = key;
		var children = [
	...
	exports["Box"] = function (components) {
		return __element79({}, components);
	}

	exports["XMLTest"] = function (components) {
		return __element82({}, components);
	}

	exports["List"] = function (components) {
		return __element83({}, components);
	}
}));
